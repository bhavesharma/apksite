...
mysql --host=$_hostsrv --user=$_db_user --password=$_db_password apksite -e "INSERT ignore INTO apkdetails SELECT * FROM stg_apkdetails WHERE stg_apkdetails.appid NOT IN (SELECT apkdetails.appid FROM apkdetails )"
